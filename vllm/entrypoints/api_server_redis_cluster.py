...
#构建所有的节点
startup_nodes = [
    {"host": "192.168.0.64", "port": 6379},  # 主
    {"host": "192.168.0.190", "port": 6379},  # 6379的从数据库
    {"host": "192.168.0.203", "port": 6379},  # 主
    {"host": "192.168.0.167", "port": 6379},  # 6380的从数据库
    {"host": "192.168.0.146", "port": 6379},  # 主
    {"host": "192.168.0.125", "port": 6379},
    {"host": "192.168.0.93", "port": 6379},
    {"host": "192.168.0.77", "port": 6379},
    {"host": "192.168.0.53", "port": 6379},
    {"host": "192.168.0.28", "port": 6379},
    {"host": "192.168.0.172", "port": 6379},
    {"host": "192.168.0.123", "port": 6379},
    {"host": "192.168.0.143", "port": 6379},
    {"host": "192.168.0.221", "port": 6379},
    {"host": "192.168.0.17", "port": 6379},
    {"host": "192.168.0.29", "port": 6379},
]
#构建StrictRedisCluster对象
redis_store = ClusterConnectionPool(startup_nodes=startup_nodes, password='0dfDF01@SA', decode_responses=True)
redis_conn = RedisCluster(connection_pool=redis_store)
...
#             })
    ...
    async def stream_results() -> AsyncGenerator[bytes, None]:
        async for request_output in results_generator:
            ...
            # print(f"<{text_outputs}> : {text_outputs.isascii()}")
        ...
        # print(f"msgId : {msgId}")
        # print(f"all_output : {request_output}")
